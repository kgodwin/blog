...
Let's start with a informative paragraph. **This text is bolded.** But not this one! _How about italic text?_ Cool right? Ok, let's **_combine_** them together. Yeah, that's right! I have code to highlight, so `ThisIsMyCode()`. What a nice! Good people will hyperlink away, so [here we go](#) or [http://www.kengodwin.com](http://www.kengodwin.com).
...
<iframe width="800" height="600" src="https://www.youtube.com/embed/lW_v_EQF9vs?ecver=1" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>

### Image

![Minion](/assets/avatar.png)
